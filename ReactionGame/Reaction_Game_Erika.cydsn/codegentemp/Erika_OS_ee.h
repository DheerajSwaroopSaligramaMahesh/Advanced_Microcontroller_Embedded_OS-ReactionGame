...
#include "Erika_OS_eecfg.inc"

#include "Erika_OS_ee_rtdruid_versions.inc"
...
#ifdef __CORTEX_MX__
#include "Erika_OS_cortex_mx_ee_cpu.inc"
#endif
...
#include "Erika_OS_ee_oo_kernel.inc"
#include "Erika_OS_ee_as_kernel.inc"
/* Moved inline interrupt services inclusion here, because they need to see TP
   declarations */
#include "Erika_OS_ee_oo_inline.inc"
#ifdef EE_AS_IOC__
#include "Erika_OS_ee_as_ioc.inc"
/*                                 WARNING
   ...
   project root. */
#include "Erika_OS_ioc_common.inc"
#endif /* EE_AS_IOC__ */

#ifdef EE_AS_SCHEDULETABLES__
#include "Erika_OS_ee_as_schedule_tables.inc"
...
/* SEM */
#ifdef __SEM__
#include "Erika_OS_ee_sem.inc"
#endif

/* ALARMS */
#ifdef __ALARMS__
#include "Erika_OS_ee_alarms.inc"
#endif

/* RN */
#if (defined(__RN__)) || (defined(EE_AS_RPC__))
#include "Erika_OS_ee_rn.inc"
...
#ifdef __ASSERT__
#include "Erika_OS_ee_assert.inc"
#endif /* __ASSERT__ */
