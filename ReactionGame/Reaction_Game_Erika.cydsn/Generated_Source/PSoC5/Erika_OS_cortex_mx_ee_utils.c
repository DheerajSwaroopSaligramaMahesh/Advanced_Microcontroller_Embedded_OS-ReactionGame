...
#include "Erika_OS_ee_internal.inc"
#include "Erika_OS_ee_irq.inc"
//~ #include "Erika_OS_cortex_mx_ee_nvic.inc"
#include "cyfitter.h"
#include "cylib.h"
...
#define ISR_MIN_PRI 48
	...
	//PF v2.5.3
    //NVIC_SET_PRI(isr_Button__INTC_NUMBER, (ISR_MIN_PRI - 5));
    CyIntSetPriority(isr_Button__INTC_NUMBER, ISR_SCALE(5));
    //\PF
